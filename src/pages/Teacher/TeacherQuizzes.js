        ...
        {!loading && !error && quizzes.map(quiz => {
          ...
          return (
            ...
            <div key={quiz.id} className={`tq-card ${!quiz.isActive ? "tq-card-closed" : ""}`}>
              ...
              {/* ✅ Schedule info */}
              <div className="tq-schedule-info">
                <div className="tq-schedule-row">
                  <span className="tq-schedule-lbl">Start</span>
                  <span className="tq-schedule-val">{formatDate(quiz.startDate)}</span>
                </div>
                <div className="tq-schedule-row">
                  <span className="tq-schedule-lbl">End</span>
                  <span className="tq-schedule-val">{formatDate(quiz.endDate)}</span>
                </div>
              </div>
